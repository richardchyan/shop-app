...
const Navbar = ({ toggleCartOpen }) => {
   return (
      <div id='#' className="py-10 mb-8 bg-blue-800 rounded-lg">
         <div className="flex justify-evenly p-2 space-x-3">
            <h1 className="text-3xl md:text-6xl text-white uppercase track-wider border-4 border-white border-dotted md:w-2/3 md:m-auto py-4">John's Pawn Shop</h1>
